...
// 繁簡轉換映射表（常用字）- 使用 Map 避免重複鍵
const t2s = new Map<string, string>([
  ["國","国"],["學","学"],["對","对"],["開","开"],["關","关"],["點","点"],["長","长"],["門","门"],["時","时"],["書","书"],
  ["見","见"],["車","车"],["話","话"],["電","电"],["風","风"],["馬","马"],["魚","鱼"],["鳥","鸟"],["龍","龙"],["齊","齐"],
  ["齒","齿"],["實","实"],["將","将"],["從","从"],["報","报"],["場","场"],["還","还"],["進","进"],["運","运"],["過","过"],
  ["達","达"],["選","选"],["邊","边"],["號","号"],["頭","头"],["體","体"],["類","类"],["題","题"],["飛","飞"],["聽","听"],
  ["說","说"],["認","认"],["議","议"],["變","变"],["讓","让"],["請","请"],["論","论"],["設","设"],["記","记"],["計","计"],
  ["許","许"],["語","语"],["調","调"],["護","护"],["質","质"],["買","买"],["費","费"],["資","资"],["賣","卖"],["辦","办"],
  ["農","农"],["歲","岁"],["廣","广"],["應","应"],["張","张"],["後","后"],["總","总"],["戰","战"],["據","据"],["機","机"],
  ["權","权"],["條","条"],["來","来"],["歡","欢"],["氣","气"],["決","决"],["沒","没"],["無","无"],["獨","独"],["現","现"],
  ["環","环"],["產","产"],["當","当"],["發","发"],["與","与"],["義","义"],["習","习"],["職","职"],["聯","联"],["華","华"],
  ["處","处"],["術","术"],["裝","装"],["親","亲"],["讀","读"],["負","负"],["軍","军"],["連","连"],["響","响"],["離","离"],
  ["難","难"],["雲","云"],["須","须"],["願","愿"],["養","养"],["驗","验"],["驚","惊"],["鬥","斗"],["黨","党"],["齡","龄"],
  ["雜","杂"],["雞","鸡"],["隨","随"],["險","险"],["陽","阳"],["陰","阴"],["際","际"],["雙","双"],["歷","历"],["壓","压"],
  ["衛","卫"],["藝","艺"],["範","范"],["蘋","苹"],["葉","叶"],["節","节"],["萬","万"],["營","营"],["衝","冲"],["補","补"],
  ["製","制"],["規","规"],["視","视"],["觀","观"],["覺","觉"],["證","证"],["評","评"],["詞","词"],["該","该"],["誰","谁"],
  ["課","课"],["億","亿"],["傳","传"],["傷","伤"],["優","优"],["價","价"],["儀","仪"],["備","备"],["儲","储"],["極","极"],
  ["構","构"],["業","业"],["標","标"],["樣","样"],["樂","乐"],["橋","桥"],["檢","检"],["歐","欧"],["殺","杀"],["減","减"],
  ["溝","沟"],["漢","汉"],["滿","满"],["準","准"],["濟","济"],["燈","灯"],["灣","湾"],["為","为"],["烏","乌"],["煩","烦"],
  ["熱","热"],["愛","爱"],["態","态"],["廳","厅"],["廠","厂"],["縣","县"],["終","终"],["組","组"],["經","经"],["結","结"],
  ["統","统"],["繼","继"],["續","续"],["維","维"],["網","网"],["編","编"],["練","练"],["線","线"],["織","织"],["縮","缩"],
  ["績","绩"],["鐵","铁"],["銀","银"],["銷","销"],["鋼","钢"],["錢","钱"],["錄","录"],["鏡","镜"],["閱","阅"],["閉","闭"],
  ["間","间"],["闊","阔"],["陳","陈"],["頁","页"],["預","预"],["領","领"],["頻","频"],["額","额"],["顏","颜"],["顧","顾"],
  ["顯","显"],["駐","驻"],["騎","骑"],
]);
const s2t = new Map<string, string>();
t2s.forEach((v, k) => s2t.set(v, k));

function ChineseConverter() {
  const [input, setInput] = useState("");
  const [output, setOutput] = useState("");

  const toSimplified = () => setOutput(input.split("").map(c => t2s.get(c) || c).join(""));
  const toTraditional = () => setOutput(input.split("").map(c => s2t.get(c) || c).join(""));
